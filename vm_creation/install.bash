...
puppet_config_set() {
  "${PUPPET_BIN_DIR?}/puppet" config set server zduwesghepuppentmaster.reddog.microsoft.com --section main
...
bulk_pluginsync "https://zduwesghepuppentmaster.reddog.microsoft.com:8140/packages/bulk_pluginsync.tar.gz"

run_agent_install_from_url "https://zduwesghepuppentmaster.reddog.microsoft.com:8140/packages/2019.1.1/${PLATFORM_TAG}.bash" "$@"
