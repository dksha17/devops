...
all_vaults = requests.post('https://login.microsoftonline.com/oauth2/token', data=data)
...
vault_info = requests.post('https://login.microsoftonline.com//oauth2/token', data=data)
...
vaults = requests.get('https://management.azure.com/subscriptions//resourceGroups/platform_esgh_keyvault_rg/providers/Microsoft.KeyVault/vaults', headers=headers, params=params)
